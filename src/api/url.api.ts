export const url = {
    ...
    getInheritParamsForTableUrl: '/index.php/UIController/GetInheritParamsForTable',
    ...
    getDataColumnTableForInterface: '/index.php/ObjectController/GetDataColumnTableForInterface',
